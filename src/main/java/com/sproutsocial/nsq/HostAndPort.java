 ...
 * @since 10.0
 */
final class HostAndPort implements Serializable {
  ...
  public static HostAndPort fromString(String hostPortString) {
    ...
    int port = NO_PORT;
    if (!Util.isNullOrEmpty(portString)) {
  ...
  public boolean equals(Object other) {
    ...
    if (other instanceof HostAndPort) {
      ...
      return Util.equal(this.host, that.host)
          && this.port == that.port
  ...
  @Override
  public int hashCode() {
    return Util.hashCode(host, port, hasBracketlessColons);
  }
